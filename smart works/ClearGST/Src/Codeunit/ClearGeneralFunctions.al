codeunit 60010 "Clear General functions"
{
    ...
    begin
        ...
        if TransLine."Document Type" = TransLine."Document Type"::Invoice then
            DetailedGSTLedgerEntry.SetRange("Document Type", DetailedGSTLedgerEntry."Document Type"::Invoice)
        else
            if TransLine."Document Type" in [TransLine."Document Type"::Credit, TransLine."Document Type"::Debit] then
