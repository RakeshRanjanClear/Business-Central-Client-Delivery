// codeunit 50118 "Clear Json Creation"
// {
//     trigger OnRun()
//     begin
...
//     procedure CreatePayload(TransHdrP: Record "ClearComp MaxITC Trans. Header"): Text
//     var
//         JObject: JsonObject;
...
//         Jarray: JsonArray;
//         ClearGSTSetup: Record "ClearComp MaxITC Setup";
...
//                 end;
//                 if (TransHdrP."Import type" <> TransHdrP."Import type"::NONE) then begin
...
//                 JTempObject.Add('itemTaxableAmount', TransLine."Taxable amount");
