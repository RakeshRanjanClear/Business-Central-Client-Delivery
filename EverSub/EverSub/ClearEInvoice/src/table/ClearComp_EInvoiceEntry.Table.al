table 50100 "ClearComp e-Invoice Entry"
{
    ...
    fields
    {
        ...
        {
            DataClassification = ToBeClassified;
            OptionMembers = " ",Invoice,CrMemo,TransferShpt,"Service Invoice","Service Credit Memo";
        ...
        field(54; "New Vehicle No."; Code[10])
        {
            DataClassification = ToBeClassified;
        ...
        field(55; "Vehicle No. Update Remark"; Option)
        {
            ...
            OptionMembers = " ",ACCIDENT,LAW_ORDER_SITUATION,NATURAL_CALAMITY,FIRST_TIME,OTHERS,TRANSSHIPMENT,BREAKDOWN;
        }
