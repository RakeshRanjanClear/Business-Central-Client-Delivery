pageextension 50101 "ClearComp Posted Sales Inv." extends "Posted Sales Invoice"
{
    actions
    {
        ...
        addafter("Generate E-Invoice")
        {
            ...
            action(CancelIRN)
            {
                ...
                begin
                    ...
                    EInvoiceManagementUnit.CancelIRN(Rec."IRN Hash", Location."ClearTax Owner Id", Location."GST Registration No.");
                    //Error(eInvoiceErr);
                end;
            }
            /*
