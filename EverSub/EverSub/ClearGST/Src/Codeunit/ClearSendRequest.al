codeunit 50114 "Clear Send request"
{
    var
    ...
    begin
        ClearGSTSetup.Get();
        Clear(TransHdr);
        TransHdr.SetRange("Sync Status", Enum::"Clear Sync status"::none);
    ...
    begin
        if APILog.Get(TransHdr."Transaction Type", TransHdr."Document Type", TransHdr."Document No.") then
            APILog.Delete();
        Clear(APILog);
