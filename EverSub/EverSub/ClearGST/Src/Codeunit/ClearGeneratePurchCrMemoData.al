codeunit 50107 "Clear Generate Purch Cr. memo"
{
    var
    ...
    begin
        ...
        TransHdr."Vendor Invoice number" := GeneralFunctions.getExternalDocumentNumber(PurchCrHdrP."No.");
    ...
    begin
        ...
        if PurchCrHdrP."Vendor GST Reg. No." <> '' then
            TransHdr."Supplier GSTIN" := PurchCrHdrP."Vendor GST Reg. No."
        else
