codeunit 60002 "Export e-Invoice Json"
{
    ...
    begin
        ...
        if IsInvoice then begin
            DocumentNo := SalesInvoiceHeader."No.";
            WriteCancellationJSON(SalesInvoiceHeader."IRN Hash", SalesInvoiceHeader."Cancel Reason", Format(SalesInvoiceHeader."Cancel Reason"))
        end
        else begin
            DocumentNo := SalesCrMemoHeader."No.";
            WriteCancellationJSON(SalesCrMemoHeader."IRN Hash", SalesCrMemoHeader."Cancel Reason", Format(SalesCrMemoHeader."Cancel Reason"));
        end;
    ...
    begin
        ...
        ELSE
            IF NOT EVALUATE(Pin, COPYSTR(SalesInvoiceHeader."Bill-to Post Code", 1, 6)) THEN ERROR(PinCodeErr, SalesInvoiceHeader."No.", SalesInvoiceHeader."Bill-to Post Code");
        IF SalesInvoiceHeader."GST Customer Type" = "GST Customer Type"::Export THEN Pin := 999999;
                ...
                SalesInvoiceLine."GST Place of Supply"::"Bill-to Address":
                    begin
                        if not (SalesInvoiceHeader."GST Customer Type" = SalesInvoiceHeader."GST Customer Type"::Export) then begin
                            ...
                            IF (SalesInvoiceHeader.State <> SalesInvoiceHeader."GST Bill-to State Code") THEN begin
                                //     StateCode := StateBuff."State Code (GST Reg. No.)";
    ...
    begin
        ...
        if CustLedgerEntry.FindFirst() then begin
            ...
            if Customers."GST Customer Type" = Customers."GST Customer Type"::Export then
